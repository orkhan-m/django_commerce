# Generated by Django 4.1.4 on 2023-02-01 20:51
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('category', models.CharField(choices=[('Strength', 'Strength'), ('Intelligence', 'Intelligence'), ('Agility', 'Agility')], default='Strength', max_length=20, unique=True)),
            ],
        ),
        migrations.CreateModel(
            name='Comment',
